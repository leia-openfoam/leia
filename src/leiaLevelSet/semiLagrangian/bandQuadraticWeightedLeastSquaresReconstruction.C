...
namespace Foam
{
    defineTypeNameAndDebug(bandQuadraticWeightedLeastSquaresReconstruction, 0);
    addToRunTimeSelectionTable
    (
        slReconstruction,
        bandQuadraticWeightedLeastSquaresReconstruction,
        Mesh
    );
    // Backward-compatible selection alias for the historical short name
    // "bandQuadraticWLSQ" (see quadraticWeightedLeastSquaresReconstruction.C).
...
Foam::bandQuadraticWeightedLeastSquaresReconstruction::bandQuadraticWeightedLeastSquaresReconstruction
(
    const fvMesh& mesh
)
:
...
void Foam::bandQuadraticWeightedLeastSquaresReconstruction::computeCellSize()
{
...
void Foam::bandQuadraticWeightedLeastSquaresReconstruction::setupBasis()
{
...
void Foam::bandQuadraticWeightedLeastSquaresReconstruction::basis
(
    const vector& d,
    const label ncoeff,
    scalarList& b
...
Foam::label Foam::bandQuadraticWeightedLeastSquaresReconstruction::fitCell
(
    const List<vector>& X,
    const List<scalar>& s,
    scalarList& coeffs
...
void Foam::bandQuadraticWeightedLeastSquaresReconstruction::update(const volScalarField& psiOld)
{
    ...
    Info<< "bandQuadraticWeightedLeastSquares: quadratic fit in " << nBand
...
Foam::scalar Foam::bandQuadraticWeightedLeastSquaresReconstruction::evaluateRaw
(
    const label c,
    const point& x
) const
...
void Foam::bandQuadraticWeightedLeastSquaresReconstruction::postAdvect(volScalarField& psi)
{
