...
% figures/tables are the single data source shared with level-set-method-comparison.template.html.
...
\begin{table}[htbp]
  ...
  \label{tab:decision}
  \resizebox{\linewidth}{!}{\input{data/tables/benchVortex_decision.tex}}
\end{table}
...
\begin{table}[htbp]
  ...
  \caption{All methods, finest $N$: errors, convergence orders, wall clock.
    ...
    variants to $256^2$.}
  \label{tab:detailed}
  \resizebox{\linewidth}{!}{\input{data/tables/benchVortex_detailed.tex}}
\end{table}
