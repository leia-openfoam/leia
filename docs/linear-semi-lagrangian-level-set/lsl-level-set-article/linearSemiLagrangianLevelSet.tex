...
% reveal deck (../lsl-level-set-presentation/linear-semi-lagrangian-level-set.template.html) and this
...
\begin{center}
\texttt{levelSet \{ semiLagrangian \{ reconstruction quadraticTaylor; \} \}}
\end{center}
